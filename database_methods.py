...
'''Database Manager that carries out the necessary functions called by the server,
   for effective implementation of a database system.
   The .db file used is task6.db'''
